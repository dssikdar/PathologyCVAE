...
if __name__ == '__main__':
    ...
    if slurm:
        ...
        file_path = os.path.join(os.path.dirname(__file__), "..", "..", "IDC_regular_ps50_idx5")
    ...
    print(f"Dataset path resolved to: {file_path}")

    # Load dataset
    full_dataset = BreastCancerDataset(file_path, transform=transform)
    ...
    if use_subset:
        subset_size = 10  # Reduce dataset size for testing
    ...
    model_path = os.path.join(script_dir, 'frozen_encoder.pth')
